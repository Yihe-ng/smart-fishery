<template>
  <div class="growth-detection-overlay">
    <svg class="mask-svg" viewBox="0 0 1 1" preserveAspectRatio="none" :style="svgStyle">
      <polygon
...
<script setup lang="ts">
  ...
  const labelBoxes = computed(() => {
    ...
    return props.detections.map((detection) => {
      ...
      const nearRight =
        props.overlayBounds.left + bboxRight + labelEstimateW >
        props.overlayBounds.left + containerW
